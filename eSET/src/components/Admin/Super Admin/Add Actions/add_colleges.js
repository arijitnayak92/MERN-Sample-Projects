...
import {Snackbar,Grid,Button,FormControl,Select,MenuItem,InputLabel} from '@material-ui/core';
   ...
   render() {
     let productForm;
            ...
            var  data1 = {
             ...
             productForm = <AddProduct username={this.props.user.username} cancel={this.updateState} action="Colleges"
              data={data1} onFormSubmit={this.onFormSubmit} campus={this.state.campus}  product={this.state.product} />
             }
...
return (
    ...
    <Grid container spacing={1}>
      <Grid item xs={6} sm={6} md={6} lg={4} xl={4} style={{padding:'40px'}}>
        <FormControl variant="outlined" style={{width:'100%'}}>
           ...
           name="campus" onChange={(e)=>this.setState({campus:e.target.value})}
           labelWidth={60}
           >
 ...
 {this.state.campus &&
    <React.Fragment>
      {!this.state.isAddProduct && <ProductList action="Colleges" campus={this.state.campus} data={data1}  editProduct={this.editProduct} />}
